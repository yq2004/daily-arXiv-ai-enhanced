...
### [20] [One Single Hub Text Breaks CLIP: Identifying Vulnerabilities in Cross-Modal Encoders via Hubness](https://arxiv.org/abs/2604.27674)
...
### [21] [Why Mean Pooling Works: Quantifying Second-Order Collapse in Text Embeddings](https://arxiv.org/abs/2604.27398)
...
### [22] [Reliable Answers for Recurring Questions: Boosting Text-to-SQL Accuracy with Template Constrained Decoding](https://arxiv.org/abs/2604.28028)
...
### [23] [Perturbation Probing: A Two-Pass-per-Prompt Diagnostic for FFN Behavioral Circuits in Aligned LLMs](https://arxiv.org/abs/2604.27401)
...
### [24] [Beyond the Mean: Within-Model Reliable Change Detection for LLM Evaluation](https://arxiv.org/abs/2604.27405)
*Jon-Paul Cacioli*
...
### [25] [Sentiment Analysis of AI Adoption in Indonesian Higher Education Using Machine Learning and Transformer-Based Models](https://arxiv.org/abs/2604.27439)
...
### [26] [From Coarse to Fine: Benchmarking and Reward Modeling for Writing-Centric Generation Tasks](https://arxiv.org/abs/2604.27453)
...
### [27] [Exploring Applications of Transfer-State Large Language Models: Cognitive Profiling and Socratic AI Tutoring](https://arxiv.org/abs/2604.27454)
*Minori Noguchi*
...
### [28] [Syntactically-guided Information Maintenance in Sentence Comprehension](https://arxiv.org/abs/2604.27468)
...
### [29] [HealthBench Professional: Evaluating Large Language Models on Real Clinician Chats](https://arxiv.org/abs/2604.27470)
...
### [30] [Skills-Coach: A Self-Evolving Skill Optimizer via Training-Free GRPO](https://arxiv.org/abs/2604.27488)
...
### [31] [Debiasing Reward Models via Causally Motivated Inference-Time Intervention](https://arxiv.org/abs/2604.27495)
...
### [32] [Qualitative Evaluation of Language Model Rescoring in Automatic Speech Recognition](https://arxiv.org/abs/2604.27533)
...
### [33] [Entropy of Ukrainian](https://arxiv.org/abs/2604.27534)
...
### [34] [HATS: An Open data set Integrating Human Perception Applied to the Evaluation of Automatic Speech Recognition Metrics](https://arxiv.org/abs/2604.27542)
...
### [35] [AppTek Call-Center Dialogues: A Multi-Accent Long-Form Benchmark for English ASR](https://arxiv.org/abs/2604.27543)
...
### [36] [APPSI-139: A Parallel Corpus of English Application Privacy Policy Summarization and Interpretation](https://arxiv.org/abs/2604.27550)
...
### [37] [JaiTTS: A Thai Voice Cloning Model](https://arxiv.org/abs/2604.27607)
...
### [38] [RoadMapper: A Multi-Agent System for Roadmap Generation of Solving Complex Research Problems](https://arxiv.org/abs/2604.27616)
...
### [39] [Mapping how LLMs debate societal issues when shadowing human personality traits, sociodemographics and social media behavior](https://arxiv.org/abs/2604.27624)
...
### [40] [Language Ideologies in a Multilingual Society: An LLM-based Analysis of Luxembourgish News Comments](https://arxiv.org/abs/2604.27661)
...
### [41] [Instruction-Guided Poetry Generation in Arabic and Its Dialects](https://arxiv.org/abs/2604.27766)
...
### [43] [Reasoning over Object Descriptions Improves Coreference Resolution in Task-Based Dialogue Systems](https://arxiv.org/abs/2604.27850)
...
### [44] [Geometry-Calibrated Conformal Abstention for Language Models](https://arxiv.org/abs/2604.27914)
...
### [45] [Beyond Semantics: Measuring Fine-Grained Emotion Preservation in Small Language Model-Based Machine Translation](https://arxiv.org/abs/2604.27920)
...
### [46] [Can AI Be a Good Peer Reviewer? A Survey of Peer Review Process, Evaluation, and the Future](https://arxiv.org/abs/2604.27924)
...
### [47] [DPN-LE: Dual Personality Neuron Localization and Editing for Large Language Models](https://arxiv.org/abs/2604.27929)
...
### [54] [A Randomized Controlled Trial and Pilot of Scout: an LLM-Based EHR Search and Synthesis Platform](https://arxiv.org/abs/2604.26953)
...
### [55] [AgenticRecTune: Multi-Agent with Self-Evolving Skillhub for Recommendation System Optimization](https://arxiv.org/abs/2604.26969)
...
### [56] [Not All Memories Age the Same: Autodiscovery of Adaptive Decay in Knowledge Graphs](https://arxiv.org/abs/2604.26970)
*Mandar Karhade*
...
### [57] [T2S-Metrics: Unified Library for Evaluating SPARQL Queries Generated From Natural Language](https://arxiv.org/abs/2604.26971)
...
### [58] [Budget-Constrained Online Retrieval-Augmented Generation: The Chunk-as-a-Service Model](https://arxiv.org/abs/2604.26981)
...
### [59] [Value-Aware Product Recommendation by Customer Segmentation using a suitable High-Dimensional Similarity Measure](https://arxiv.org/abs/2604.26983)
...
### [60] [LUCid: Redefining Relevance For Lifelong Personalization](https://arxiv.org/abs/2604.26996)
...
### [61] [Hypencoder Revisited: Reproducibility and Analysis of Non-Linear Scoring for First-Stage Retrieval](https://arxiv.org/abs/2604.27037)
...
### [62] [A Gated Hybrid Contrastive Collaborative Filtering Recommendation](https://arxiv.org/abs/2604.27117)
...
### [63] [LLM-Enhanced Topical Trend Detection at Snapchat](https://arxiv.org/abs/2604.27131)
...
### [64] [RAQG-QPP: Query Performance Prediction with Retrieved Query Variants and Retrieval Augmented Query Generation](https://arxiv.org/abs/2604.27244)
...
### [65] [NuggetIndex: Governed Atomic Retrieval for Maintainable RAG](https://arxiv.org/abs/2604.27306)
...
### [66] [From Unstructured to Structured: LLM-Guided Attribute Graphs for Entity Search and Ranking](https://arxiv.org/abs/2604.27410)
...
### [67] [A Reproducibility Study of LLM-Based Query Reformulation](https://arxiv.org/abs/2604.27421)
...
### [68] [Reproducing Adaptive Reranking for Reasoning-Intensive IR](https://arxiv.org/abs/2604.27577)
...
### [69] [One Pass, Any Order: Position-Invariant Listwise Reranking for LLM-Based Recommendation](https://arxiv.org/abs/2604.27599)
...
### [70] [Purifying Multimodal Retrieval: Fragment-Level Evidence Selection for RAG](https://arxiv.org/abs/2604.27600)
...
### [71] [Position-Aware Drafting for Inference Acceleration in LLM-Based Generative List-Wise Recommendation](https://arxiv.org/abs/2604.27747)
...
### [72] [How Generative AI Disrupts Search: An Empirical Study of Google Search, Gemini, and AI Overviews](https://arxiv.org/abs/2604.27790)
...
### [73] [NeocorRAG: Less Irrelevant Information, More Explicit Evidence, and More Effective Recall via Evidence Chains](https://arxiv.org/abs/2604.27852)
...
### [74] [SimEval-IR: A Unified Toolkit and Benchmark Suite for Evaluating User Simulators and Search Sessions](https://arxiv.org/abs/2604.27878)
*Saber Zerhoudi*
...
### [75] [Efficient Multivector Retrieval with Token-Aware Clustering and Hierarchical Indexing](https://arxiv.org/abs/2604.28142)
