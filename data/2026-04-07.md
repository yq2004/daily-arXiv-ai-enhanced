...
### [19] [Text Summarization With Graph Attention Networks](https://arxiv.org/abs/2604.03583)
...
### [20] [A Semi-Automated Annotation Workflow for Paediatric Histopathology Reports Using Small Language Models](https://arxiv.org/abs/2604.04168)
...
### [21] [MultiPress: A Multi-Agent Framework for Interpretable Multimodal News Classification](https://arxiv.org/abs/2604.03586)
...
### [22] [SkillX: Automatically Constructing Skill Knowledge Bases for Agents](https://arxiv.org/abs/2604.04804)
...
### [23] [Unveiling Language Routing Isolation in Multilingual MoE Models for Interpretable Subnetwork Adaptation](https://arxiv.org/abs/2604.03592)
...
### [24] [The Format Tax](https://arxiv.org/abs/2604.03616)
...
### [25] [CAGMamba: Context-Aware Gated Cross-Modal Mamba Network for Multimodal Sentiment Analysis](https://arxiv.org/abs/2604.03650)
...
### [26] [Document-Level Numerical Reasoning across Single and Multiple Tables in Financial Reports](https://arxiv.org/abs/2604.03664)
...
### [27] [AI Appeals Processor: A Deep Learning Approach to Automated Classification of Citizen Appeals in Government Services](https://arxiv.org/abs/2604.03672)
...
### [28] ['Layer su Layer': Identifying and Disambiguating the Italian NPN Construction in BERT's family](https://arxiv.org/abs/2604.03673)
...
### [29] [Unlocking Prompt Infilling Capability for Diffusion Language Models](https://arxiv.org/abs/2604.03677)
...
### [30] [Researchers waste 80% of LLM annotation costs by classifying one text at a time](https://arxiv.org/abs/2604.03684)
...
### [31] [POEMetric: The Last Stanza of Humanity](https://arxiv.org/abs/2604.03695)
...
### [32] [Testing the Limits of Truth Directions in LLMs](https://arxiv.org/abs/2604.03754)
...
### [33] [Your Agent is More Brittle Than You Think: Uncovering Indirect Injection Vulnerabilities in Agentic LLMs](https://arxiv.org/abs/2604.03870)
...
### [34] [When Models Know More Than They Say: Probing Analogical Reasoning in LLMs](https://arxiv.org/abs/2604.03877)
...
### [35] [I-CALM: Incentivizing Confidence-Aware Abstention for LLM Hallucination Mitigation](https://arxiv.org/abs/2604.03904)
...
### [36] [From Plausible to Causal: Counterfactual Semantics for Policy Evaluation in Simulated Online Communities](https://arxiv.org/abs/2604.03920)
...
### [37] [Uncertainty as a Planning Signal: Multi-Turn Decision Making for Goal-Oriented Conversation](https://arxiv.org/abs/2604.03924)
...
### [45] [Embedding Enhancement via Fine-Tuned Language Models for Learner-Item Cognitive Modeling](https://arxiv.org/abs/2604.04088)
...
### [46] [Shorter, but Still Trustworthy? An Empirical Study of Chain-of-Thought Compression](https://arxiv.org/abs/2604.04120)
...
### [47] [Many Preferences, Few Policies: Towards Scalable Language Model Personalization](https://arxiv.org/abs/2604.04144)
...
### [49] [Which English Do LLMs Prefer? Triangulating Structural Bias Towards American English in Foundation Models](https://arxiv.org/abs/2604.04204)
...
### [50] [DARE: Diffusion Large Language Models Alignment and Reinforcement Executor](https://arxiv.org/abs/2604.04215)
...
### [51] [CAWN: Continuous Acoustic Wave Networks for Autoregressive Language Modeling](https://arxiv.org/abs/2604.04250)
...
### [52] [Adaptive Cost-Efficient Evaluation for Reliable Patent Claim Validation](https://arxiv.org/abs/2604.04295)
...
### [53] [High-Stakes Personalization: Rethinking LLM Customization for Individual Investor Decision-Making](https://arxiv.org/abs/2604.04300)
*Yash Ganpat Sawant*
...
### [54] [How Well Do Agentic Skills Work in the Wild: Benchmarking LLM Skill Usage in Realistic Settings](https://arxiv.org/abs/2604.04323)
...
### [55] [Benchmarking Multi-turn Medical Diagnosis: Hold, Lure, and Self-Correction](https://arxiv.org/abs/2604.04325)
...
### [56] [GROUNDEDKG-RAG: Grounded Knowledge Graph Index for Long-document Question Answering](https://arxiv.org/abs/2604.04359)
...
### [57] [Compressible Softmax-Attended Language under Incompressible Attention](https://arxiv.org/abs/2604.04384)
*Wonsuk Lee*
...
### [58] [How Alignment Routes: Localizing, Scaling, and Controlling Policy Circuits in Language Models](https://arxiv.org/abs/2604.04385)
*Gregory N. Frank*
...
### [59] [Responses Fall Short of Understanding: Revealing the Gap between Internal Representations and Responses in Visual Document Understanding](https://arxiv.org/abs/2604.04411)
...
### [60] [Structured Causal Video Reasoning via Multi-Objective Alignment](https://arxiv.org/abs/2604.04415)
...
### [76] [Hallucination Basins: A Dynamic Framework for Understanding and Controlling LLM Hallucinations](https://arxiv.org/abs/2604.04743)
...
### [77] [HUKUKBERT: Domain-Specific Language Model for Turkish Law](https://arxiv.org/abs/2604.04790)
...
### [78] [How Far Are We? Systematic Evaluation of LLMs vs. Human Experts in Mathematical Contest in Modeling](https://arxiv.org/abs/2604.04791)
...
### [88] [BridgeRAG: Training-Free Bridge-Conditioned Retrieval for Multi-Hop Question Answering](https://arxiv.org/abs/2604.03384)
*Andre Bacellar*
...
### [89] [Align then Train: Efficient Retrieval Adapter Learning](https://arxiv.org/abs/2604.03403)
...
### [90] [Lightweight Query Routing for Adaptive RAG: A Baseline Study on RAGRouter-Bench](https://arxiv.org/abs/2604.03455)
...
### [91] [LLM-based Listwise Reranking under the Effect of Positional Bias](https://arxiv.org/abs/2604.03642)
...
### [92] [Joint Behavior-guided and Modality-coherence Conditional Graph Diffusion Denoising for Multi Modal Recommendation](https://arxiv.org/abs/2604.03654)
...
### [93] [MMP-Refer: Multimodal Path Retrieval-augmented LLMs For Explainable Recommendation](https://arxiv.org/abs/2604.03666)
*Xiangchen Pan,Wei Wei*
...
### [94] [User Simulator-Guided Multi-Turn Preference Optimization for Reasoning LLM-based Conversational Recommendation](https://arxiv.org/abs/2604.03671)
...
### [95] [Are LLM-Based Retrievers Worth Their Cost? An Empirical Study of Efficiency, Robustness, and Reasoning Overhead](https://arxiv.org/abs/2604.03676)
...
### [96] [Fusion and Alignment Enhancement with Large Language Models for Tail-item Sequential Recommendation](https://arxiv.org/abs/2604.03688)
...
### [97] [Rank, Don't Generate: Statement-level Ranking for Explainable Recommendation](https://arxiv.org/abs/2604.03724)
...
### [98] [Semantic IDs for Recommender Systems at Snapchat: Use Cases, Technical Challenges, and Design Choices](https://arxiv.org/abs/2604.03949)
...
### [99] [MisEdu-RAG: A Misconception-Aware Dual-Hypergraph RAG for Novice Math Teachers](https://arxiv.org/abs/2604.04036)
...
### [100] [FLAME: Condensing Ensemble Diversity into a Single Network for Efficient Sequential Recommendation](https://arxiv.org/abs/2604.04038)
...
### [101] [Formalized Information Needs Improve Large-Language-Model Relevance Judgments](https://arxiv.org/abs/2604.04140)
...
### [102] [A Logical-Rule Autoencoder for Interpretable Recommendations](https://arxiv.org/abs/2604.04270)
...
### [103] [FAVE: Flow-based Average Velocity Establishment for Sequential Recommendation](https://arxiv.org/abs/2604.04427)
...
### [104] [Retrieval Augmented Conversational Recommendation with Reinforcement Learning](https://arxiv.org/abs/2604.04457)
...
### [105] [SLSREC: Self-Supervised Contrastive Learning for Adaptive Fusion of Long- and Short-Term User Interests](https://arxiv.org/abs/2604.04530)
...
### [106] [Ruling Out to Rule In: Contrastive Hypothesis Retrieval for Medical Question Answering](https://arxiv.org/abs/2604.04593)
...
### [107] [Beyond Hard Negatives: The Importance of Score Distribution in Knowledge Distillation for Dense Retrieval](https://arxiv.org/abs/2604.04734)
