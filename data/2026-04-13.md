...
### [11] [MAB-DQA: Addressing Query Aspect Importance in Document Question Answering with Multi-Armed Bandits](https://arxiv.org/abs/2604.08952)
...
### [13] [RecaLLM: Addressing the Lost-in-Thought Phenomenon with Explicit In-Context Retrieval](https://arxiv.org/abs/2604.09494)
...
### [15] [Case-Grounded Evidence Verification: A Framework for Constructing Evidence-Sensitive Supervision](https://arxiv.org/abs/2604.09537)
...
### [16] [Sentiment Classification of Gaza War Headlines: A Comparative Analysis of Large Language Models and Arabic Fine-Tuned BERT Models](https://arxiv.org/abs/2604.08566)
...
### [17] [Multi-User Large Language Model Agents](https://arxiv.org/abs/2604.08567)
...
### [18] [Can We Still Hear the Accent? Investigating the Resilience of Native Language Signals in the LLM Era](https://arxiv.org/abs/2604.08568)
...
### [19] [Adaptive Rigor in AI System Evaluation using Temperature-Controlled Verdict Aggregation via Generalized Power Mean](https://arxiv.org/abs/2604.08595)
*Aleksandr Meshkov*
...
### [20] [EXAONE 4.5 Technical Report](https://arxiv.org/abs/2604.08644)
...
### [21] [Decomposing the Delta: What Do Models Actually Learn from Preference Pairs?](https://arxiv.org/abs/2604.08723)
...
### [22] [LLMs Underperform Graph-Based Parsers on Supervised Relation Extraction for Complex Graphs](https://arxiv.org/abs/2604.08752)
...
### [23] [Cards Against LLMs: Benchmarking Humor Alignment in Large Language Models](https://arxiv.org/abs/2604.08757)
...
### [24] [Revisiting Anisotropy in Language Transformers: The Geometry of Learning Dynamics](https://arxiv.org/abs/2604.08764)
...
### [25] [MT-OSC: Path for LLMs that Get Lost in Multi-Turn Conversation](https://arxiv.org/abs/2604.08782)
...
### [26] [MedConceal: A Benchmark for Clinical Hidden-Concern Reasoning Under Partial Observability](https://arxiv.org/abs/2604.08788)
...
### [27] [Lessons Without Borders? Evaluating Cultural Alignment of LLMs Using Multilingual Story Moral Generation](https://arxiv.org/abs/2604.08797)
...
### [28] [Scalable High-Recall Constraint-Satisfaction-Based Information Retrieval for Clinical Trials Matching](https://arxiv.org/abs/2604.08849)
...
### [29] [Cross-Lingual Attention Distillation with Personality-Informed Generative Augmentation for Multilingual Personality Recognition](https://arxiv.org/abs/2604.08851)
...
### [30] [GRASP: Grounded CoT Reasoning with Dual-Stage Optimization for Multimodal Sarcasm Target Identification](https://arxiv.org/abs/2604.08879)
...
### [31] [NCL-BU at SemEval-2026 Task 3: Fine-tuning XLM-RoBERTa for Multilingual Dimensional Sentiment Regression](https://arxiv.org/abs/2604.08923)
...
### [32] [MuTSE: A Human-in-the-Loop Multi-use Text Simplification Evaluator](https://arxiv.org/abs/2604.08947)
...
### [33] [TaxPraBen: A Scalable Benchmark for Structured Evaluation of LLMs in Chinese Real-World Tax Practice](https://arxiv.org/abs/2604.08948)
...
### [34] [Breaking Block Boundaries: Anchor-based History-stable Decoding for Diffusion Large Language Models](https://arxiv.org/abs/2604.08964)
...
### [35] [Litmus (Re)Agent: A Benchmark and Agentic System for Predictive Evaluation of Multilingual Models](https://arxiv.org/abs/2604.08970)
...
### [36] [Confident in a Confidence Score: Investigating the Sensitivity of Confidence Scores to Supervised Fine-Tuning](https://arxiv.org/abs/2604.08974)
...
### [37] [Quantisation Reshapes the Metacognitive Geometry of Language Models](https://arxiv.org/abs/2604.08976)
*Jon-Paul Cacioli*
...
### [38] [Testing the Assumptions of Active Learning for Translation Tasks with Few Samples](https://arxiv.org/abs/2604.08977)
...
### [39] [PerMix-RLVR: Preserving Persona Expressivity under Verifiable-Reward Alignment](https://arxiv.org/abs/2604.08986)
...
### [40] [ASTRA: Adaptive Semantic Tree Reasoning Architecture for Complex Table Question Answering](https://arxiv.org/abs/2604.08999)
...
### [41] [Towards Linguistically-informed Representations for English as a Second or Foreign Language: Review, Construction and Application](https://arxiv.org/abs/2604.09008)
...
### [42] [CONDESION-BENCH: Conditional Decision-Making of Large Language Models in Compositional Action Space](https://arxiv.org/abs/2604.09029)
...
### [43] [Anchored Sliding Window: Toward Robust and Imperceptible Linguistic Steganography](https://arxiv.org/abs/2604.09066)
...
### [44] [NyayaMind- A Framework for Transparent Legal Reasoning and Judgment Prediction in the Indian Legal System](https://arxiv.org/abs/2604.09069)
...
### [45] [Hierarchical Alignment: Enforcing Hierarchical Instruction-Following in LLMs through Logical Consistency](https://arxiv.org/abs/2604.09075)
...
### [46] [Interactive ASR: Towards Human-Like Interaction and Semantic Coherence Evaluation for Agentic Speech Recognition](https://arxiv.org/abs/2604.09121)
...
### [47] [Prototype-Regularized Federated Learning for Cross-Domain Aspect Sentiment Triplet Extraction](https://arxiv.org/abs/2604.09123)
...
### [48] [Think Less, Know More: State-Aware Reasoning Compression with Knowledge Guidance for Efficient Reasoning](https://arxiv.org/abs/2604.09150)
...
### [49] [Persona-E$^2$: A Human-Grounded Dataset for Personality-Shaped Emotional Responses to Textual Events](https://arxiv.org/abs/2604.09162)
...
### [50] [Facet-Level Tracing of Evidence Uncertainty and Hallucination in RAG](https://arxiv.org/abs/2604.09174)
...
### [51] [Do LLMs Follow Their Own Rules? A Reflexive Audit of Self-Stated Safety Policies](https://arxiv.org/abs/2604.09189)
*Avni Mittal*
...
### [52] [SPASM: Stable Persona-driven Agent Simulation for Multi-turn Dialogue Generation](https://arxiv.org/abs/2604.09212)
*Han Luo,Guy Laban*
...
### [53] [ScheMatiQ: From Research Question to Structured Data through Interactive Schema Discovery](https://arxiv.org/abs/2604.09237)
...
### [54] [EthicMind: A Risk-Aware Framework for Ethical-Emotional Alignment in Multi-Turn Dialogue](https://arxiv.org/abs/2604.09265)
...
### [55] [Task-Aware LLM Routing with Multi-Level Task-Profile-Guided Data Synthesis for Cold-Start Scenarios](https://arxiv.org/abs/2604.09377)
...
### [56] [Automated Instruction Revision (AIR): A Structured Comparison of Task Adaptation Strategies for LLM](https://arxiv.org/abs/2604.09418)
...
### [58] [Many-Tier Instruction Hierarchy in LLM Agents](https://arxiv.org/abs/2604.09443)
...
### [59] [From Reasoning to Agentic: Credit Assignment in Reinforcement Learning for Large Language Models](https://arxiv.org/abs/2604.09459)
*Chenchen Zhang*
...
### [60] [Across the Levels of Analysis: Explaining Predictive Processing in Humans Requires More Than Machine-Estimated Probabilities](https://arxiv.org/abs/2604.09466)
...
### [62] [BERT-as-a-Judge: A Robust Alternative to Lexical Methods for Efficient Reference-Based LLM Evaluation](https://arxiv.org/abs/2604.09497)
...
### [63] [You Can't Fight in Here! This is BBS!](https://arxiv.org/abs/2604.09501)
...
### [64] [Many Ways to Be Fake: Benchmarking Fake News Detection Under Strategy-Driven AI Generation](https://arxiv.org/abs/2604.09514)
...
### [66] [VerifAI: A Verifiable Open-Source Search Engine for Biomedical Question Answering](https://arxiv.org/abs/2604.08549)
...
### [67] [Unbiased Rectification for Sequential Recommender Systems Under Fake Orders](https://arxiv.org/abs/2604.08550)
...
### [68] [Pretrain-then-Adapt: Uncertainty-Aware Test-Time Adaptation for Text-based Person Search](https://arxiv.org/abs/2604.08598)
...
### [69] [SkillForge: Forging Domain-Specific, Self-Evolving Agent Skills in Cloud Technical Support](https://arxiv.org/abs/2604.08618)
...
### [70] [BracketRank: Large Language Model Document Ranking via Reasoning-based Competitive Elimination](https://arxiv.org/abs/2604.08834)
...
### [71] [Beyond Relevance: Utility-Centric Retrieval in the LLM Era](https://arxiv.org/abs/2604.08920)
...
### [72] [IAT: Instance-As-Token Compression for Historical User Sequence Modeling in Industrial Recommender Systems](https://arxiv.org/abs/2604.08933)
...
### [73] [Regime-Conditional Retrieval: Theory and a Transferable Router for Two-Hop QA](https://arxiv.org/abs/2604.09019)
*Andre Bacellar*
...
### [74] [DIAURec: Dual-Intent Space Representation Optimization for Recommendation](https://arxiv.org/abs/2604.09087)
...
### [75] [Hybrid Cold-Start Recommender System for Closure Model Selection in Multiphase Flow Simulations](https://arxiv.org/abs/2604.09112)
...
### [76] [On the Representational Limits of Quantum-Inspired 1024-D Document Embeddings: An Experimental Evaluation Framework](https://arxiv.org/abs/2604.09430)
*Dario Maio*
...
### [77] [TME-PSR: Time-aware, Multi-interest, and Explanation Personalization for Sequential Recommendation](https://arxiv.org/abs/2604.09439)
...
### [78] [Dynamic Ranked List Truncation for Reranking Pipelines via LLM-generated Reference-Documents](https://arxiv.org/abs/2604.09492)
